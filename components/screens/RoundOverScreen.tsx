...
import { Trophy, ShieldAlert, Heart, Coins, Compass, TrendingUp, ArrowRight, RefreshCw, Sparkles, Skull } from 'lucide-react';
          ...
          <div className="relative z-10 w-full flex flex-col items-center pt-10 pb-6 px-8">
              ...
              <div className="w-full bg-slate-900/80 border border-slate-700/50 rounded-2xl overflow-hidden backdrop-blur-sm">
                  ...
                  <div className="p-5 space-y-4">
                      ...
                      {/* Essence Reward */}
                      <div className="flex items-center justify-between">
                          <span className="text-xs font-bold text-slate-400 uppercase tracking-wide">{t.ui.essence_earned}</span>
                          <div className="flex items-center gap-2 bg-slate-950 px-3 py-1.5 rounded-lg border border-slate-800">
                              <span className="text-xl font-black text-emerald-400">+{summary.adventurePointsEarned}</span>
