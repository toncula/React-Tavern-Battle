...
export const TAVERN_UPGRADE_BASE_COST = 5;
...
export const getBaseTavernCost = (currentTier: number): number => {
    return TAVERN_UPGRADE_BASE_COST + (currentTier * 2);
};
